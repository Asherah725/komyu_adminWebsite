    ...
    <div>
      ...
      <div class="menu">
        ...
        <a href="commuters.php">
          <img src="gray-icons/gray-commuters.png" alt="Commuters" class="menu-icon"> Commuters</a>
        ...
        <a href="payments&points.php">
          ...
          <img src="white-icons/white-settings.png" alt="Acount Settings" class="menu-icon"> Account Settings</a>
      </div>
    </div>
  ...
  <div class="profile-header">
    <div class="profile-info">
      ...
      <div class="profile-details">
        <strong>Mark Jay</strong><br>
        <small>📞 09051235314</small>
      </div>
    </div>
  ...
  <div class="settings-container">
    ...
    <div class="card">
      ...
      <div class="input-group">
        <label>Email</label>
        <input type="email" value="markjay243895@gmail.com" disabled>
      </div>
      <div class="input-group">
